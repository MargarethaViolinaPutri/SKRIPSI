...
export default function QuestionIndex() {
    const load = async (params: Record<string, unknown>) => {
        const response = await axios.get<Base<Question[]>>(route('operational.question.fetch', params));
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="center">
                            <Link href={route('operational.question.show', { id: row.original.id })}>
                                <DropdownMenuItem>
                                    <Eye /> Detail
                                </DropdownMenuItem>
                            </Link>
    ...
    return (
        <div>
            <div className="flex flex-row items-center justify-between">
                ...
                {/* Removed Add Data button to make the page strictly read-only */}
            </div>
            <div className="my-4">
                <NextTable<Question>
                    enableSelect={true}
